...
<head>
    ...
    <meta name="description" content="<?php echo isset($seodata['metadesc'])?$seodata['metadesc']:'sarkari jobs,govt jobs';?>">
    <?php 
...
<meta property="og:title" content="<?php echo isset($seodata['title'])?$seodata['title']:'sarkari jobs,govt jobs,job notifications';?>" />
    <meta name="author" content="">

    <title><?php echo isset($seodata['title'])?$seodata['title']:'sarkari jobs,govt jobs,job notifications';?></title>

    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url();?>sarkariassets/css/bootstrap.min.css" rel="stylesheet">
