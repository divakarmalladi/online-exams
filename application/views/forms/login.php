...
$logiUrl = isset($exam_id)?'login/'.$exam_id:'login';
?>
<!DOCTYPE html>
<html lang="en">
	<head>
	  ...
	  <title>Login - KeytoQuestions</title>
		...
		<script type="text/javascript">
			$('#login_form').on('submit', function(e){
				...
				if(Object.keys(errors).length<=0){
					formValid = ajax_request('<?php echo $logiUrl;?>', 'dashboard', $('#login_form').serialize(), 'POST', 'submit');
				}
				return false;
			});
		</script>
