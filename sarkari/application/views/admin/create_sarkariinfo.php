            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <option value='<?php echo $scval->sub_cid;?>'><?php echo $scval->sub_categoryname;?></option>
                        <?php }?>
                        </select> 
                    </div>
                    <div class="form-group">
                        ...
                        <option value='<?php echo $stval->sid;?>'><?php echo $stval->state_name;?></option>
                        <?php }?>
                        </select> 
                    </div>
                    <div class="form-group">
                        ...
                        <option value='<?php echo $jtval->jid;?>'><?php echo $jtval->job_type;?></option>
                        <?php }?>
                        </select> 
                    </div>
                    <div class="form-group">
                        <select id='status' class="form-control" name='status' ><option value='0'>In Active</option> <option value='1'>Active</option></select>  
                    </div>
                </div>
                </div>
                <div class="row">
                <div class="col-md-12">
                    <div class="form-group" >
                    <textarea id="editor" name='jobdesc'></textarea>
