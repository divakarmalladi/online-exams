				...
				<div class="row">
					<div class="col-lg-6">
					    <div class="blog-details">
							<p>Tourism typically combines tour and travel components to create a great happy holiday for you. We are one of the leading operators based at Warangal.</p>
                            <p>Tourism have great flow of regular customers, by whose recommendation we have a sound booking throughout the year. We feel very happy introducing ourselves to have a mutual and longlasting business associated with most of the travel agencies all over India. We have never ceased in pleasing our customers with the very best service we strive to provide our customer a very comfortable and memorable stay.</p>
						</div>
					</div>
                    <div class="col-lg-6">
                        <div class="sidebar">
                         <img src="assets/img/tourism-services1.jpg" alt="Tourism Services" title="Tourism Services">
                    
                        </div>
                    </div>
                    <div class="col-lg-12">
                    <p>We are commited to offering travel services of the highest quality combining our satisfaction comes in serving large number of satisfied clients, who have experienced the joy and inspiration of travel. Our support with the customers at personal level has earned us a good number of regular clients throughout the India. Making a joyful and lasting impression of the customers has been.</p>
                    </div>
