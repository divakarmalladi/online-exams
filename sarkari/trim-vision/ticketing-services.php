				...
				<div class="row">
					<div class="col-lg-6">
					    <div class="blog-details">
							<h2>Airline Ticketing
</h2>                            <p>Nowadays, Airline Ticketing has become an easy process due to a number of companies providing ticketing services. Based in Warangal, Onestop Forex And Holidays Private Limited is a well reputed Tour & Travel Company, which provides unparalleled Airline Ticketing Services. We, at Onestop Forex And Holidays Private Limited, offer the clients with the best Airline Ticketing Services at the most affordable and reasonable charges. We have a dedicated team of Airline Ticketing Agents, who deal with the clients in a highly cooperative manner. Besides, this we also provide the clients with all the essential information regarding the arrival and departure of flights. </p>
						</div>
					</div>
                    <div class="col-lg-6">
                        <div class="sidebar" style="top:10px;">
                         <img src="assets/img/tickting-services.png" alt="Ticketing Services" title="Ticketing Services" style="height:270px;"> 
                    
                        </div>
                    </div>
                    <div class="col-lg-12">
                    <h2>Rail Ticketing</h2>
                    <p>Rail Ticketing has become an easy process nowadays due to a large number of travel companies operating in the market. Based in Warangal, Onestop Forex And Holidays Private Limited is a prominent Tour & Travel Company, which provides excellent Rail Ticketing Services. We, at Onestop Forex And Holidays Private Limited, offer the clients with the best Rail Ticketing Services at the most affordable and reasonable charges. With the help of our efficient Rail Ticketing Agents, we make sure that you get the best Rail Ticketing Deals. Besides this, we will also provide you with the necessary information regarding arrival and departure of trains.</p>
                    </div>
