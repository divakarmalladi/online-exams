				...
				<div class="row">
					<div class="col-lg-6">
					    <div class="blog-details">
							<p>Trim Vision Services is a one-stop destination for all your passport services and we understand that the process of acquiring a passport is quite time consuming. We have a team of experienced people well versed with all the formalities required for passport assistance and guide our customers according to the rules and regulations. By the help of our expert's advice you will not only be able to avoid common mistakes but also avoid any kind of delays.</p>
						</div>
					</div>
                    <div class="col-lg-6">
                        <div class="sidebar">
                         <img src="assets/img/passport-services.jpg" alt="Passport Services" title="Passport Services">
                    
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <p>
                        If you'd like to apply for a passport or it's related services simply contact us. we are undertaking all type of passport services like:
                                   
                        </p>
                        <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">New (fresh) Passport,</i>
							</div>
                         </p>
                         <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">Renewal of Passport, </i>
							</div>
                         </p>
                         <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">Correction in Passport data,</i>
							</div>
                         </p>
                         <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">Change of Name,</i>
							</div>
                         </p>
                         <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">Duplicate Passport, </i>
							</div>
                         </p>
                         <p> <div class="feature-box-icon">
							   <i class="icofont icofont-code-alt">Minor (up to 18 years) Passport works, and Change of Address etc.</i>
							</div>
                         </p>
                         <p>
                         The entire process of passport is managed professionally by us, making your papers move quickly. The people who manage the services are highly qualified persons who know how to eliminate the unnecessary problems in the application process. There are some documents required for having a fresh passport.
